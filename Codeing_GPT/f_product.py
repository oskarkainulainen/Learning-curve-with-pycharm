...
# hyperparameters
batch_size = 32   # How many independant sequnces will process in parallel?
...
# List of unique characters that occur on the list
...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        wei = wei.masked_fill(self.trial[:T, :T] == 0, float('-inf'))  # (B, T, T)
...
class BigramLanguageModel(nn.Module):
    ...
    def forward(self, idx, targets= None):
        ...
        x = self.sa_head # apply one head of self-attention. (B,T,C)
